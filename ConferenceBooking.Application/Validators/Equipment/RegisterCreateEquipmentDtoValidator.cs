...
{
    public class RegisterCreateEquipmentDtoValidator : AbstractValidator<CreateEquipmentDto>
    {
        public RegisterCreateEquipmentDtoValidator(IUnitOfWork unitOfWork)
        {
